...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    if (!a.jQuery) {
        ...
        c.isWindow = function(a) {
            ...
            if (d) {
                if (g) for (;f > e && !1 !== c.apply(a[e], d); e++) ; else for (e in a) if (!1 === c.apply(a[e], d)) break;
            } else if (g) for (;f > e && !1 !== c.call(a[e], e, a[e]); e++) ; else for (e in a) if (!1 === c.call(a[e], e, a[e])) break;
            return a;
    ...
    return function(a, b, c, d) {
        ...
        function j(a, b) {
            ...
            !1 === c && (c = t.Easings[t.defaults.easing] ? t.defaults.easing : s), c;
        }
        function k(a) {
            if (a) {
        ...
        function l(a, b) {
            ...
            t.State.calls[a] = !1;
            for (var o = 0, p = t.State.calls.length; p > o; o++) if (!1 !== t.State.calls[o]) {
                i = !0;
                break;
            }
        ...
        var m, n = function() {
            ...
            for (var a = 7; a > 4; a--) {
                ...
                if (b.innerHTML = "\x3c!--[if IE " + a + "]><span></span><![endif]--\x3e", b.getElementsByTagName("span").length) return b = null, 
                a;
            }
            return d;
        }(), o = function() {
        ...
        var u = function() {
            ...
            return function a(b, d, e) {
                ...
                for (b = parseFloat(b) || 500, d = parseFloat(d) || 20, e = e || null, i.tension = b, 
                i.friction = d, f = null !== e, f ? (k = a(b, d), g = k / e * .016) : g = .016; h = c(h || i, g), 
                j.push(1 + h.x), k += 16, Math.abs(h.x) > 1e-4 && Math.abs(h.v) > 1e-4; ) ;
                return f ? function(a) {
        ...
        var v = t.CSS = {
            ...
            Hooks: {
                ...
                injectValue: function(a, b, c) {
                    ...
                    if (d) {
                        var e, f = d[0], g = d[1];
                        return c = v.Hooks.cleanRootPropertyValue(f, c), e = c.toString().match(v.RegEx.valueSplit), 
                        e[g] = b, e.join(" ");
                    }
                    return c;
                }
        ...
        var w = function() {
            ...
            function e() {
                function a(a) {
                    ...
                    if ("scroll" === C) {
                        var r, u, w, z = /^x$/i.test(h.axis) ? "Left" : "Top", A = parseFloat(h.offset) || 0;
                        h.container ? p.isWrapped(h.container) || p.isNode(h.container) ? (h.container = h.container[0] || h.container, 
                        r = h.container["scroll" + z], w = r + m(f).position()[z.toLowerCase()] + A) : h.container = null : (r = t.State.scrollAnchor[t.State["scrollProperty" + z]], 
                        u = t.State.scrollAnchor[t.State["scrollProperty" + ("Left" === z ? "Top" : "Left")]], 
                        w = m(f).offset()[z.toLowerCase()] + A), i = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: r,
                                currentValue: r,
                        ...
                        for (var E in D) if ("element" !== E) {
                            var F = D[E].startValue;
                            D[E].startValue = D[E].currentValue = D[E].endValue, D[E].endValue = F, p.isEmptyObject(s) || (D[E].easing = h.easing), 
                        ...
                        for (var G in q) {
                            var H = l(q[G]), K = H[0], L = H[1], M = H[2];
                            G = v.Names.camelCase(G);
                            var N = v.Hooks.getRoot(G), O = !1;
                            if (g(f).isSVG || "tween" === N || !1 !== v.Names.prefixCheck(N)[1] || v.Normalizations.registered[N] !== d) {
                                ...
                                h._cacheValues && D && D[G] ? (M === d && (M = D[G].endValue + D[G].unitType), O = g(f).rootPropertyValueCache[N]) : v.Hooks.registered[G] ? M === d ? (O = v.getPropertyValue(f, N), 
                                M = v.getPropertyValue(f, G, O)) : O = v.Hooks.templates[N][1] : M === d && (M = v.getPropertyValue(f, G));
                                var P, Q, R, S = !1;
                                if (P = n(G, M), M = P[0], R = P[1], P = n(G, K), K = P[0].replace(/^([+-\/*])=/, function(a, b) {
                                    return S = b, "";
                                }), Q = P[1], M = parseFloat(M) || 0, K = parseFloat(K) || 0, "%" === Q && (/^(fontSize|lineHeight)$/.test(G) ? (K /= 100, 
                                Q = "em") : /^scale/.test(G) ? (K /= 100, Q = "") : /(Red|Green|Blue)$/i.test(G) && (K = K / 100 * 255, 
                                Q = "")), /[\/*]/.test(S)) Q = R; else if (R !== Q && 0 !== M) if (0 === K) Q = R; else {
                                    e = e || function() {
                                        var a = {
                    ...
                    !1 === t.State.isTicking && (t.State.isTicking = !0, k())) : y++);
                }
                ...
                h.mobileHA = h.mobileHA && t.State.isMobile && !t.State.isGingerbread, !1 === h.queue ? h.delay ? setTimeout(a, h.delay) : a() : m.queue(f, h.queue, function(b, c) {
                    return !0 === c ? (B.promise && B.resolver(o), !0) : (t.velocityQueueEntryFlag = !0, 
                    void a(b));
    ...
    function A(a, b, c) {
        var d = c.pointers.length, e = c.changedPointers.length, f = b & wa && 0 == d - e, g = b & (ya | za) && 0 == d - e;
    ...
    function R(a, b) {
        ...
        if (f = c.filter(function(a) {
            return p(a.target, i);
        }), b === wa) for (e = 0; e < f.length; ) d[f[e].identifier] = !0, e++;
        for (e = 0; e < g.length; ) d[g[e].identifier] && h.push(g[e]), b & (ya | za) && delete d[g[e].identifier], 
        e++;
    ...
    function V(a) {
        ...
        this.state = cb, this.simultaneous = {}, this.requireFail = [];
    }
    function W(a) {
    ...
    var ia = [ "", "webkit", "moz", "MS", "ms", "o" ], ja = b.createElement("div"), ka = "function", la = Math.round, ma = Math.abs, na = Date.now, oa = 1, pa = /mobile|tablet|ip(ad|hone|od)|android/i, qa = "ontouchstart" in a, ra = v(a, "PointerEvent") !== d, sa = qa && pa.test(navigator.userAgent), ta = "touch", ua = "mouse", va = 25, wa = 1, xa = 2, ya = 4, za = 8, Aa = 1, Ba = 2, Ca = 4, Da = 8, Ea = 16, Fa = Ba | Ca, Ga = Da | Ea, Ha = Fa | Ga, Ia = [ "x", "y" ], Ja = [ "clientX", "clientY" ];
    y.prototype = {
        handler: function() {},
        init: function() {
    ...
    var Ka = {
        ...
        mousemove: xa,
        mouseup: ya
    }, La = "mousedown", Ma = "mousemove mouseup";
    j(M, y, {
        handler: function(a) {
            var b = Ka[a.type];
            b & wa && 0 === a.button && (this.pressed = !0), b & xa && 1 !== a.which && (b = ya), 
    ...
    var Na = {
        ...
        4: ua,
        5: "kinect"
    }, Pa = "pointerdown", Qa = "pointermove pointerup pointercancel";
    a.MSPointerEvent && (Pa = "MSPointerDown", Qa = "MSPointerMove MSPointerUp MSPointerCancel"), 
    j(N, y, {
        handler: function(a) {
            var b = this.store, c = !1, d = a.type.toLowerCase().replace("ms", ""), e = Na[d], f = Oa[a.pointerType] || a.pointerType, g = f == ta, h = s(b, a.pointerId, "pointerId");
    ...
    j(Q, y, {
        handler: function(a) {
            var b = Ua[a.type], c = R.call(this, a, b);
        ...
        handler: function(a, b, c) {
            var d = c.pointerType == ta, e = c.pointerType == ua;
    ...
    var Wa = v(ja.style, "touchAction"), Xa = Wa !== d, Ya = "compute", Za = "auto", $a = "manipulation", _a = "none", ab = "pan-x", bb = "pan-y";
    T.prototype = {
        set: function(a) {
        ...
        preventDefaults: function(a) {
            if (!Xa) {
                ...
                var d = this.actions, e = q(d, _a), f = q(d, bb), g = q(d, ab);
    ...
    var cb = 1, db = 2, eb = 4, fb = 8, gb = fb, hb = 16;
    V.prototype = {
        defaults: {},
        set: function(a) {
        ...
        recognize: function(a) {
            var b = h({}, a);
            return l(this.options.enable, [ this, b ]) ? (this.state & (gb | hb | 32) && (this.state = cb), 
            this.state = this.process(b), void (this.state & (db | eb | fb | hb) && this.tryEmit(b))) : (this.reset(), 
            void (this.state = 32));
        },
        process: function() {},
        ...
        process: function(a) {
            var b = this.state, c = a.eventType, d = b & (db | eb), e = this.attrTest(a);
        ...
        directionTest: function(a) {
            ...
            return e & b.direction || (b.direction & Fa ? (e = 0 === f ? Aa : 0 > f ? Ba : Ca, 
            c = f != this.pX, d = Math.abs(a.deltaX)) : (e = 0 === g ? Aa : 0 > g ? Da : Ea, 
        ...
        process: function(a) {
            ...
            if (this._input = a, !d || !c || a.eventType & (ya | za) && !f) this.reset(); else if (a.eventType & wa) this.reset(), 
            this._timer = e(function() {
                this.state = gb, this.tryEmit();
            }, b.time, this); else if (a.eventType & ya) return gb;
            return 32;
        },
        reset: function() {
        ...
        emit: function(a) {
            this.state === gb && (a && a.eventType & ya ? this.manager.emit(this.options.event + "up", a) : (this._input.timeStamp = na(), 
        ...
        attrTest: function(a) {
            ...
            return c & (Fa | Ga) ? b = a.velocity : c & Fa ? b = a.velocityX : c & Ga && (b = a.velocityY), 
    ...
    fa.prototype = {
        ...
        recognize: function(a) {
            ...
            if (!b.stopped) {
                ...
                !e && c.state & (db | eb | fb) && (e = b.curRecognizer = c), f++;
            }
        },
        get: function(a) {
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, function(a) {
    a.fn.collapsible = function(b) {
        ...
        return b = a.extend(c, b), this.each(function() {
            ...
            g.off("click.collapse", "> li > .collapsible-header"), h.off("click.collapse"), 
            g.on("click.collapse", "> li > .collapsible-header", function(g) {
                var h = a(this), j = a(g.target);
                e(j) && (j = f(j)), j.toggleClass("active"), b.accordion || "accordion" === i || void 0 === i ? c(j) : (d(j), 
    ...
    a.fn.scrollTo = function(b) {
        ...
        this.each(function() {
            ...
            function e(b) {
                ...
                if (!0 === h.belowOrigin && (n = f), k + j.innerWidth() > a(window).width() ? m = "right" : k - j.innerWidth() + g.innerWidth() < 0 && (m = "left"), 
                l + j.innerHeight() > e) if (l + f - j.innerHeight() < 0) {
                    var o = e - l - n;
                    j.css("max-height", o);
            ...
            if (d(), g.after(j), h.hover) {
                ...
                e("click")), j.hasClass("active") && a(document).bind("click." + j.attr("id") + " touchstart." + j.attr("id"), function(b) {
    ...
    a.fn.materialbox = function() {
        return this.each(function() {
            function b() {
                f = !1;
                var b = h.parent(".material-placeholder"), d = (window.innerWidth, window.innerHeight, 
                h.data("width")), i = h.data("height");
                h.velocity("stop", !0), a("#materialbox-overlay").velocity("stop", !0), a(".materialbox-caption").velocity("stop", !0), 
                a("#materialbox-overlay").velocity({
                    ...
                    complete: function() {
                        b.css({
                            ...
                            position: "",
                            "z-index": ""
                        }), h.removeClass("active"), f = !0, a(this).remove(), c.css("overflow", "");
                    }
                });
            }
            if (!a(this).hasClass("initialized")) {
                a(this).addClass("initialized");
                var c, d, e = !1, f = !0, g = 200, h = a(this), i = a("<div></div>").addClass("material-placeholder");
                h.wrap(i), h.on("click", function() {
                    var g = h.parent(".material-placeholder"), i = window.innerWidth, j = window.innerHeight, k = h.width(), l = h.height();
                    if (!1 === f) return b(), !1;
                    if (e && !0 === f) return b(), !1;
                    ...
                    for (;null !== d && !a(d).is(document); ) {
                        var m = a(d);
                        "hidden" === m.css("overflow") && (m.css("overflow", "visible"), c = void 0 === c ? m : c.add(m)), 
                        d = d.parentNode;
                    }
                    h.css({
                        position: "absolute",
                    ...
                    if (a("body").append(n), n.velocity({
                        ...
                        o.text(h.data("caption")), a("body").append(o), o.css({
                            display: "inline"
                        }), o.velocity({
                            opacity: 1
                        }, {
                    ...
                    var p = 0, q = k / i, r = l / j, s = 0, t = 0;
                    q > r ? (p = l / k, s = .9 * i, t = .9 * i * p) : (p = k / l, s = .9 * j * p, t = .9 * j), 
                    h.hasClass("responsive-img") ? h.velocity({
                        "max-width": s,
                        width: k
                    }, {
                        duration: 0,
    ...
    var b = {
        init: function() {
            return this.each(function() {
                ...
                h = e.index(c), h < 0 && (h = 0), d = a(c[0].hash), b.append('<div class="indicator"></div>');
                ...
                b.is(":visible") && (i.css({
                    ...
                    f = b.width(), g = b.find("li").first().outerWidth(), h < 0 && (h = 0), 0 !== g && 0 !== f && (i.css({
                        right: f - (h + 1) * g
                    }), i.css({
                        left: h * g
                    }));
                    ...
                    var k = h;
                    h = e.index(a(this)), h < 0 && (h = 0), d.show(), h - k >= 0 ? (i.velocity({
                        right: f - (h + 1) * g
                    }, {
                        duration: 300,
                        queue: !1,
    ...
    a.fn.tooltip = function(c) {
        ...
        return "remove" === c ? (this.each(function() {
            ...
            var d = Materialize.guid(), e = a(this);
            e.attr("data-tooltip-id", d);
            var f = a("<span></span>").text(e.attr("data-tooltip")), g = a("<div></div>");
            g.addClass("material-tooltip").append(f).appendTo(a("body")).attr("id", d);
            var h = a("<div></div>").addClass("backdrop");
            h.appendTo(g), h.css({
                top: 0,
                left: 0
            ...
            e.on({
                "mouseenter.tooltip": function(a) {
                    ...
                    d = void 0 === d || "" === d ? c.delay : d, i = setTimeout(function() {
                        j = !0, g.velocity("stop"), h.velocity("stop"), g.css({
                            display: "block",
                            left: "0px",
                            top: "0px"
                        }), g.children("span").text(e.attr("data-tooltip"));
                        var a, c, d, f = e.outerWidth(), i = e.outerHeight(), k = e.attr("data-position"), l = g.outerHeight(), m = g.outerWidth(), n = "0px", o = "0px", p = 8;
                        "top" === k ? (a = e.offset().top - l - 5, c = e.offset().left + f / 2 - m / 2, 
                        d = b(c, a, m, l), n = "-10px", h.css({
                            borderRadius: "14px 14px 0 0",
                            transformOrigin: "50% 90%",
                            marginTop: l,
                            marginLeft: m / 2 - h.width() / 2
                        })) : "left" === k ? (a = e.offset().top + i / 2 - l / 2, c = e.offset().left - m - 5, 
                        d = b(c, a, m, l), o = "-10px", h.css({
                            width: "14px",
                            height: "14px",
                            ...
                            marginTop: l / 2,
                            marginLeft: m
                        })) : "right" === k ? (a = e.offset().top + i / 2 - l / 2, c = e.offset().left + f + 5, 
                        d = b(c, a, m, l), o = "+10px", h.css({
                            width: "14px",
                            height: "14px",
                            ...
                            marginTop: l / 2,
                            marginLeft: "0px"
                        })) : (a = e.offset().top + e.outerHeight() + 5, c = e.offset().left + f / 2 - m / 2, 
                        d = b(c, a, m, l), n = "+10px", h.css({
                            marginLeft: m / 2 - h.width() / 2
                        })), g.css({
                            top: d.y,
                            left: d.x
                        }), p = m / 8, p < 8 && (p = 8), "right" !== k && "left" !== k || (p = m / 10) < 6 && (p = 6), 
                        g.velocity({
                            marginTop: n,
                            marginLeft: o
                        }, {
                ...
                "mouseleave.tooltip": function() {
                    j = !1, clearTimeout(i), setTimeout(function() {
                        1 != j && (g.velocity({
                            opacity: 0,
                            marginTop: 0,
                            marginLeft: 0
                            ...
                            queue: !1,
                            complete: function() {
                                h.css("display", "none"), g.css("display", "none"), j = !1;
                            }
                        }));
                    }, 225);
                }
    ...
    function d(a) {
        ...
        return b = f.documentElement, void 0 !== a.getBoundingClientRect && (e = a.getBoundingClientRect()), 
        d = c(f), {
    ...
    var h = h || {}, i = document.querySelectorAll.bind(document), j = {
        ...
        hide: function(a) {
            k.touchup(a);
            var b = this, c = (b.clientWidth, null), d = b.getElementsByClassName("waves-ripple");
    ...
    var g = b, h = setInterval(function() {
        null === f.parentNode && window.clearInterval(h), f.classList.contains("panning") || (g -= 20), 
        g <= 0 && (Vel(f, {
            opacity: 0,
            marginTop: "-40px"
        }, {
        ...
        init: function(b) {
            ...
            b = a.extend(c, b), a(this).each(function() {
                ...
                f.css({
                    ...
                    e.css("width", b.menuWidth)) : !1 === h && ("left" === b.edge ? e.css("left", -1 * (b.menuWidth + 10)) : e.css("right", -1 * (b.menuWidth + 10)));
                ...
                f.on("click", function() {
                    ...
                    if ("touch" == d.gesture.pointerType) {
                        ...
                        if ("left" === b.edge && (f > b.menuWidth ? f = b.menuWidth : f < 0 && (f = 0)), 
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        ...
                        g = !1, "left" === b.edge ? h && d <= .3 || d < -.5 ? (e.velocity({
                            left: 0
                        }, {
                            duration: 300,
                            queue: !1,
    ...
    function c() {
        ...
        a.each(i, function(a, b) {
            "number" != typeof b.data("scrollSpy:ticks") && b.triggerHandler("scrollSpy:enter"), 
    ...
    function e(a, b, c) {
        ...
        return function() {
            ...
            h || !1 !== c.leading || (h = j);
            var k = b - (j - h);
            return d = this, e = arguments, k <= 0 ? (clearTimeout(g), g = null, h = j, f = a.apply(d, e), 
            d = e = null) : g || !1 === c.trailing || (g = setTimeout(i, k)), f;
        };
    }
    ...
    a(document).ready(function() {
        ...
        Materialize.updateTextFields = function() {
            a("input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea").each(function(b, c) {
                a(c).val().length > 0 || c.autofocus || void 0 !== a(this).attr("placeholder") || !0 === a(c)[0].validity.badInput ? a(this).siblings("label, i").addClass("active") : a(this).siblings("label, i").removeClass("active");
            });
        };
        ...
        a(document).on("change", c, function() {
            ...
            0 === a.val().length && !1 === a[0].validity.badInput ? a.hasClass("validate") && (a.removeClass("valid"), 
        ...
        a(document).on("change", f, function(b) {
            ...
            a(this).after(c)), c.find(".value").html(a(this).val()), g = !0, a(this).addClass("active"), 
            c.hasClass("active") || c.velocity({
                ...
                duration: 300,
                easing: "easeOutExpo"
            }), "input" !== b.type && (e = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left, 
            e < 0 ? e = 0 : e > d && (e = d), c.addClass("active").css("left", e)), c.find(".value").html(a(this).val());
        ...
        a(this).each(function() {
            ...
            if (!d.hasClass("browser-default")) {
                ...
                var i = a('<ul id="select-options-' + g + '" class="dropdown-content select-dropdown ' + (e ? "multiple-select-dropdown" : "") + '"></ul>'), j = d.children("option, optgroup"), k = [], l = !1, m = d.find("option:selected").html() || d.find("option:first").html() || "", n = function(b, c, d) {
                    ...
                    if (f) {
                        var h = "";
                        return g && (h = ' class="' + g + '"'), "multiple" === d ? i.append(a('<li class="' + e + '"><img src="' + f + '"' + h + '><span><input type="checkbox"' + e + "/><label></label>" + c.html() + "</span></li>")) : i.append(a('<li class="' + e + '"><img src="' + f + '"' + h + "><span>" + c.html() + "</span></li>")), 
                        !0;
                    }
                ...
                j.length && j.each(function() {
                    ...
                    a(this).click(function(g) {
                        if (!a(this).hasClass("disabled") && !a(this).hasClass("optgroup")) {
                            ...
                            a(this).toggleClass("active"), q.val(a(this).text())), activateOption(i, a(this)), 
                            d.find("option").eq(f).prop("selected", h), d.trigger("change"), void 0 !== b && b();
                        }
                        g.stopPropagation();
                    });
                }), d.wrap(h);
                ...
                var r = [], s = function(b) {
                    ...
                    if (13 != b.which || i.is(":visible")) {
                        ...
                        activateOption(i, g)), 27 == b.which && q.trigger("close"), 38 == b.which && (g = i.find("li.selected").prev("li:not(.disabled)")[0]) && activateOption(i, g), 
                        setTimeout(function() {
                            r = [];
                        }, 1e3);
                    }
    ...
    var b = {
        init: function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                ...
                function d(a) {
                    a >= j.length ? a = 0 : a < 0 && (a = j.length - 1), (k = i.find(".active").index()) != a && (e = j.eq(k), 
                ...
                h.hammer({
                    ...
                    n || m ? m ? (d(curr_index + 1), $curr_slide.velocity({
    ...
    var b = function(b) {
        if ($this = b, !1 === $this.hasClass("active")) {
            ...
            !0 === e ? d = 40 : c = 40, $this.addClass("active"), $this.find("ul .btn-floating").velocity({
                scaleY: ".4",
                scaleX: ".4",
                translateY: c + "px",
                translateX: d + "px"
    ...
    function b(f, g, i, l) {
        ...
        function p() {
            var b;
            !0 === u.hiddenName ? (b = f.name, f.name = "") : (b = [ "string" == typeof u.hiddenPrefix ? u.hiddenPrefix : "", "string" == typeof u.hiddenSuffix ? u.hiddenSuffix : "_submit" ], 
        ...
        function q(a) {
            ...
            (32 == b || c || !t.open && y.component.key[b]) && (a.preventDefault(), a.stopPropagation(), 
        ...
        var s = !1, t = {
            ...
            open: function(c) {
                ...
                }, 0), !1 !== c && (t.open = !0, s && k.css("overflow", "hidden").css("padding-right", "+=" + d()), 
    ...
    function c(a) {
        var b;
        return a.currentStyle ? b = a.currentStyle.position : window.getComputedStyle && (b = getComputedStyle(a).position), 
        "fixed" == b;
    }
    function d() {
    ...
    c.prototype.set = function(a, b, c) {
        ...
        var f, g = this;
        return c = void 0 === c ? a : c, c == -1 / 0 || c == 1 / 0 ? f = c : b.isPlainObject(c) && d.isInteger(c.pick) ? c = c.obj : b.isArray(c) ? (c = new Date(c[0], c[1], c[2]), 
        c = d.isDate(c) ? c : g.create().obj) : c = d.isInteger(c) || d.isDate(c) ? g.normalize(new Date(c), e) : g.now(a, c, e), 
        {
        ...
        var f, g, h, i, j = this, k = c, l = e && e.interval ? e.interval : 1, m = -1 === j.item.enable, n = j.item.min, o = j.item.max, p = m && j.item.disable.filter(function(a) {
            if (b.isArray(a)) {
        ...
        if ((!e || !e.nav) && (!m && j.disabled(c) || m && j.disabled(c) && (p || f || g) || !m && (c.pick <= n.pick || c.pick >= o.pick))) for (m && !p && (!g && l > 0 || !f && l < 0) && (l *= -1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k, 
        ...
        var c = this, e = c.item.disable.filter(function(e) {
        ...
        var e = this, f = {};
        return b && "string" == typeof b ? (c && c.format || (c = c || {}, c.format = e.settings.format), 
        e.formats.toArray(c.format).map(function(a) {
            var c = e.formats[a], g = c ? d.trigger(c, e, [ b, f ]) : a.replace(/^!/, "").length;
        ...
        var e = this, f = e.settings.firstDay ? 1 : 0;
        ...
        var e = this, f = e.item.disable.slice(0);
        return "flip" == c ? e.flipEnable() : !1 === c ? (e.flipEnable(1), f = []) : !0 === c ? (e.flipEnable(-1), 
        f = []) : c.map(function(a) {
            for (var c, g = 0; g < f.length; g += 1) if (e.isDateExact(a, f[g])) {
                c = !0;
                break;
            }
        ...
        var e = this, f = e.item.disable, g = f.length;
        return "flip" == c ? e.flipEnable() : !0 === c ? (e.flipEnable(1), f = []) : !1 === c ? (e.flipEnable(-1), 
        f = []) : c.map(function(a) {
            var c, h, i, j;
            for (i = 0; i < g; i += 1) {
            ...
            if (c) for (i = 0; i < g; i += 1) if (e.isDateExact(f[i], a)) {
                f[i] = null;
                break;
            }
            if (j) for (i = 0; i < g; i += 1) if (e.isDateOverlap(f[i], a)) {
                f[i] = null;
                break;
            }
            c && f.push(c);
        ...
        var b = this, c = b.settings, e = b.item, f = e.now, g = e.select, h = e.highlight, i = e.view, j = e.disable, k = e.min, l = e.max, m = function(a, b) {
        ...
        }((c.showWeekdaysFull ? c.weekdaysFull : c.weekdaysLetter).slice(0), c.weekdaysFull.slice(0)), n = function(a) {
            ...
            var f = i.year, g = !0 === c.selectYears ? 5 : ~~(c.selectYears / 2);
            if (g) {
                var h = k.year, j = l.year, m = f - g, n = f + g;
        ...
        }, d.node("div", d.node("div", createWeekdayLabel(), "picker__weekday-display") + d.node("div", o("short_months"), c.klass.month_display) + d.node("div", createDayLabel(), c.klass.day_display) + d.node("div", p("raw"), c.klass.year_display), c.klass.date_display) + d.node("div", d.node("div", (c.selectYears, 
        o() + p() + n() + n(1)), c.klass.header) + d.node("table", m + d.node("tbody", d.group({
            min: 0,
            max: 5,
            i: 1,
            node: "tr",
            item: function(a) {
                ...
                return [ d.group({
                    ...
                    item: function(a) {
                        ...
                        var e = g && g.pick == a.pick, m = h && h.pick == a.pick, n = j && b.disabled(a) || a.pick < k.pick || a.pick > l.pick, o = d.trigger(b.formats.toString, b, [ c.format, a ]);
                        return [ d.node("div", a.date, function(b) {
                            return b.push(i.month == a.month ? c.klass.infocus : c.klass.outfocus), f.pick == a.pick && b.push(c.klass.now), 
                            e && b.push(c.klass.selected), m && b.push(c.klass.highlighted), n && b.push(c.klass.disabled), 
                            b.join(" ");
    ...
    function b() {
        var b = +a(this).attr("length"), c = +a(this).val().length, d = c <= b;
    ...
    a.fn.characterCounter = function() {
        return this.each(function() {
            void 0 !== a(this).attr("length") && (a(this).on("input", b), a(this).on("focus", b), 
            a(this).on("blur", d), c(a(this)));
        });
    }, a(document).ready(function() {
    ...
    var b = {
        init: function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                ...
                function e(a) {
                    return a >= r ? a % r : a < 0 ? e(r + a % r) : a;
                }
                function f(a) {
                    var c, d, f, g, h, i, j;
                    for (n = "number" == typeof a ? a : n, o = Math.floor((n + q / 2) / q), f = n - o * q, 
                    g = f < 0 ? 1 : -1, h = -g * f * 2 / q, b.full_width ? j = "translateX(0)" : (j = "translateX(" + (E[0].clientWidth - item_width) / 2 + "px) ", 
                    j += "translateY(" + (E[0].clientHeight - item_width) / 2 + "px)"), i = m[e(o)], 
                    i.style[x] = j + " translateX(" + -f / 2 + "px) translateX(" + g * b.shift * h * c + "px) translateZ(" + b.dist * h + "px)", 
                    i.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * h, 
                    i.style.opacity = tweenedOpacity, d = r >> 1, c = 1; c <= d; ++c) b.full_width ? (zTranslation = b.dist, 
                    tweenedOpacity = c === d && f < 0 ? 1 - h : 1) : (zTranslation = b.dist * (2 * c + h * g), 
                    tweenedOpacity = 1 - .2 * (2 * c + h * g)), i = m[e(o + c)], i.style[x] = j + " translateX(" + (b.shift + (q * c - f) / 2) + "px) translateZ(" + zTranslation + "px)", 
                    i.style.zIndex = -c, i.style.opacity = tweenedOpacity, b.full_width ? (zTranslation = b.dist, 
                    tweenedOpacity = c === d && f > 0 ? 1 - h : 1) : (zTranslation = b.dist * (2 * c - h * g), 
                    tweenedOpacity = 1 - .2 * (2 * c - h * g)), i = m[e(o - c)], i.style[x] = j + " translateX(" + (-b.shift + (-q * c - f) / 2) + "px) translateZ(" + zTranslation + "px)", 
                    i.style.zIndex = -c, i.style.opacity = tweenedOpacity;
                    i = m[e(o)], i.style[x] = j + " translateX(" + -f / 2 + "px) translateX(" + g * b.shift * h + "px) translateZ(" + b.dist * h + "px)", 
                    i.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * h, 
                    i.style.opacity = tweenedOpacity;
                }
                function g() {
                    var a, b, c, d;
                    a = Date.now(), b = a - A, A = a, c = n - z, z = n, d = 1e3 * c / (1 + b), w = .8 * d + .2 * w;
                }
                function h() {
                    var a, c;
                    u && (a = Date.now() - A, c = u * Math.exp(-a / b.time_constant), c > 2 || c < -2 ? (f(v - c), 
                    requestAnimationFrame(h)) : f(v));
                }
                function i(c) {
                    if (C) return c.preventDefault(), c.stopPropagation(), !1;
                    if (!b.full_width) {
                        var d = a(c.target).closest(".carousel-item").index(), e = o % r - d;
                        e < 0 ? Math.abs(e + r) < Math.abs(e) && (e += r) : e > 0 && Math.abs(e - r) < e && (e -= r), 
                        e < 0 ? a(this).trigger("carouselNext", [ Math.abs(e) ]) : e > 0 && a(this).trigger("carouselPrev", [ e ]);
                    }
                }
                function j(a) {
                    p = !0, C = !1, D = !1, s = c(a), t = d(a), w = u = 0, z = n, A = Date.now(), clearInterval(B), 
                    B = setInterval(g, 100);
                }
                function k(a) {
                    var b, e;
                    if (p) if (b = c(a), y = d(a), e = s - b, Math.abs(t - y) < 30 && !D) (e > 2 || e < -2) && (C = !0, 
                    s = b, f(n + e)); else {
                        if (C) return a.preventDefault(), a.stopPropagation(), !1;
                        D = !0;
                    }
                    if (C) return a.preventDefault(), a.stopPropagation(), !1;
                }
                function l(a) {
                    return p = !1, clearInterval(B), v = n, (w > 10 || w < -10) && (u = .9 * w, v = n + u), 
                    v = Math.round(v / q) * q, u = v - n, A = Date.now(), requestAnimationFrame(h), 
                    a.preventDefault(), a.stopPropagation(), !1;
                }
                var m, n, o, p, q, r, s, t, u, v, w, x, z, A, B, C, D, E = a(this);
                if (E.hasClass("initialized")) return !0;
                b.full_width && (b.dist = 0, imageHeight = E.find(".carousel-item img").first().load(function() {
                    E.css("height", a(this).height());
                })), E.addClass("initialized"), p = !1, n = v = 0, m = [], item_width = E.find(".carousel-item").first().innerWidth(), 
                q = 2 * item_width + b.padding, E.find(".carousel-item").each(function() {
                    m.push(a(this)[0]);
                }), r = m.length, x = "transform", [ "webkit", "Moz", "O", "ms" ].every(function(a) {
                    var b = a + "Transform";
                    return void 0 === document.body.style[b] || (x = b, !1);
                }), window.onresize = f, function() {
                    void 0 !== window.ontouchstart && (E[0].addEventListener("touchstart", j), E[0].addEventListener("touchmove", k), 
                    E[0].addEventListener("touchend", l)), E[0].addEventListener("mousedown", j), E[0].addEventListener("mousemove", k), 
                    E[0].addEventListener("mouseup", l), E[0].addEventListener("click", i);
                }(), f(n), a(this).on("carouselNext", function(a, b) {
                    void 0 === b && (b = 1), v = n + q * b, n !== v && (u = v - n, A = Date.now(), requestAnimationFrame(h));
