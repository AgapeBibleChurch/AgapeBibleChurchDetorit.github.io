 ...
 */ 
 ...
 function church_admin_show_comments($comment_type,$ID)
 {
 	...
 	$sql='SELECT a.*, CONCAT_WS(" ",b.first_name,b.prefix,b.last_name) AS name FROM '.CA_COM_TBL.' a LEFT JOIN '.CA_PEO_TBL.' b ON a.author_id=b.user_id WHERE a.ID="'.esc_sql($ID).'" AND a.comment_type="'.esc_sql($comment_type).'" ORDER BY timestamp ASC';
