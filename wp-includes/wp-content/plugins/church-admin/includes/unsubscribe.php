...
<article>
	...
	}else echo'<p>'.__('You have been unsubscribed from our email list','church-admin').'</p>';
	
   	echo'<a href="'.site_url().'?ca_sub='.esc_html($_GET['ca_unsub']).'">'.__('Oops, please resubscribe me','church-admin').'</a></p>';
    ?>
    <div>
