...
function church_admin_names($member_type_id,$people_type_id)
{
    ...
    if(!empty($memb_sql)||!empty($people_sql)){$where=' WHERE ';} else{$where='';}
    ...
    $sql='SELECT first_name,middle_name,nickname,prefix,last_name FROM '.CA_PEO_TBL.$where.' ORDER BY last_name';
